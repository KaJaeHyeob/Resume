...
고객사의 가장 큰 걱정은 프로젝트의 성공 유무가 아닌 개정안 적용 직후부터 e-Invoicing 프로그램 도입 전까지 발생될 영업손실이었습니다. 기존 시스템의 고도화는 어려운 작업이었지만, e-Invoicing 프로그램만을 사용하는 신규 시스템을 구축하는 건 상대적으로 쉬운 작업이었습니다. 자사 서버의 유휴 리소스에 브릿지 시스템을 구축하고 기존 시스템과 인터페이스 연결함으로써 고객사의 걱정거리를 임시적으로 해소시킬 수 있었고, 이후 3개월 간의 프로젝트는 성공적으로 마무리될 수 있었습니다.    
